  ...
  return (
    <div className='flex flex-col bg-white items-center min-w-[200px] text-center p-8 ml-10 mr-10 rounded-xl transition duration-450 hover:shadow-2xl'>
      ...
      <p className='text-gray-700 m-0.5 '>
        Otaniemi Fight Club is an incredible place to train and grow in martial arts! The instructors are highly
        skilled, approachable, and passionate about helping everyone improve, regardless of experience level.
      </p>
    </div>
  );
};
